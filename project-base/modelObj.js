...
Model.prototype.initParameters = function () {
    ...
    this.scale = 0.4; // mise à l'echelle (car l'objet est trop  gros par défaut)
}
...
Model.prototype.setParameters = function (elapsed) {
    ...
    var sMat2 = mat4.scale(mat4.identity(), [1, 1, (Math.sin(this.time)*0.5+0.5)+0.1]);
...
Model.prototype.move = function (x, y) {
    ...
    this.rotation += x * 0.01 + 0.1; // permet de tourner autour de l'axe Y
    this.position[0] += x * 0.08; // translation gauche/droite
    this.position[1] += y * 0.08; // translation haut/bas
